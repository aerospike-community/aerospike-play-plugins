...
pomExtra := {
  <scm>
    <url>https://github.com/aerospike/aerospike-java-plugins/tree/master/play-plugins/cache-plugin</url>
...
homepage := Some(url(s"https://github.com/aerospike/aerospike-java-plugins/tree/master/play-plugins/cache-plugin"))
licenses := Seq("Apache-2.0" -> url("http://www.apache.org/licenses/LICENSE-2.0.html"))

sonatypeProfileName := "com.aerospike"
